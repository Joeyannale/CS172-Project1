...
public class Project1 {
  ...
  */
  public static String functionF(String rightHalf, String subKey) {
    ...
    int group1Row = parseInt(group1.substring(0,4), 2);
    int group1Col = parseInt(group1.substring(4,8), 2);
    int group2Row = parseInt(group2.substring(0,4), 2);
    int group2Col = parseInt(group2.substring(4,8), 2);
    int group3Row = parseInt(group3.substring(0,4), 2);
    int group3Col = parseInt(group3.substring(4,8), 2);
    int group4Row = parseInt(group4.substring(0,4), 2);
    int group4Col = parseInt(group4.substring(4,8), 2);
